...
getUsersResponse = WS.sendRequest(findTestObject('GET users'), FailureHandling.STOP_ON_FAILURE)
...
// Retrieve the random value from the array using the random index
